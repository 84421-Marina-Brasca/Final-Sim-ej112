...
namespace TP4.Entidades
{
    internal class GestorSimulacion
    {
        ...
        private Tipo[] Disciplinas = { new Tipo("Basket", 0), new Tipo("Futbol", 1), new Tipo("Handball", 1) };
        ...
        private Paciente?[] DeportistasEnSistema;
            ...
            double tLimpieza) 
        {
            ...
            DeportistasEnSistema = new Paciente[6];
        ...
        public double CalcularFinOcupacionCancha(double rnd, Paciente d)
        {
        ...
        private static void SumarAEsperaFinalizadaSegunTipoDeportista(string[] linea, Paciente dep, double reloj)
        {
