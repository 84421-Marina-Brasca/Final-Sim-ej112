...
namespace TP4
{
    public partial class PantallaSimParametros : Form
    {
        ...
        private bool faltanParams()
        {
            ...
            bool faltaDistribucion = estaVacio(txt_expLlegConsulta.Text) || estaVacio(txt_distLlegHBDesde.Text) || estaVacio(txt_distLlegHBHasta.Text) || estaVacio(txt_distLlegBBDesde.Text) || estaVacio(txt_distLlegBBHasta.Text);
            bool faltaOcupacion = estaVacio(txt_A_finAtencConsulta.Text) || estaVacio(txt_B_finAtencConsulta.Text) || estaVacio(txt_A_finAtencUrgencia.Text) || estaVacio(txt_B_finAtencUrgencia.Text) || estaVacio(txt_distOcupBBDesde.Text) || estaVacio(txt_distOcupBBHasta.Text);
        ...
        private void btn_generar_Click(object sender, EventArgs e)
        {
            ...
            double limsLlegFutbol = Double.Parse(txt_expLlegConsulta.Text) * 60;
            ...
            double[] limsOcupFutbol = new double[] { Double.Parse(txt_A_finAtencConsulta.Text), Double.Parse(txt_B_finAtencConsulta.Text) };
            double[] limsOcupHandball = new double[] { Double.Parse(txt_A_finAtencUrgencia.Text), Double.Parse(txt_distOcupBBHasta.Text) };
